...
const PUBLIC_SCENE_RECIPES = [
  {
    id: 'miami-air-293',
    title: 'Miami Air 293 - Runway Overrun',
    version: 1,
    // Install into existing saved projects (not just fresh ones), anchored after
    // a core built-in so returning users see it in the dropdown too.
    installAlongsideSceneId: 'flights-radar',
    style: 'normal',
    ui: { hidePanels: false, hudMode: 'full', safeFrame: '16:9' },
    layers: {},
    post: {
      ...
      sharpen: true,
      detectionMode: 'OFF',
      // No forced mapStack: inherit the active basemap so keyless runs get Esri
      // imagery, while users with a Cesium/Google key can view it on photoreal 3D.
    },
    dataPacks: [
      {
        id: 'approach',
    ...
    cameraPath: [
      {
        title: 'Approach into Jacksonville',
        lat: 30.2313252,
        lon: -81.7707043,
        alt: 1249.7,
        heading: 90,
        ...
        duration: 5,
        hold: 1.5,
        dataPackIds: ['approach'],
      },
      {
        title: '21:40:25  3.5 nm final, ~1400 ft, above glidepath',
        lat: 30.2310986,
        lon: -81.7572243,
        alt: 399.2,
        heading: 90.0,
      ...
      {
        title: '21:41:17  1 nm, roll 12 deg right',
        lat: 30.2311316,
        lon: -81.7090852,
        alt: 161.5,
        heading: 91.1,
      ...
      {
        title: '21:41:28  0.5 nm, 220 ft right of centreline',
        lat: 30.2309736,
        lon: -81.6994566,
        alt: 82.2,
        heading: 87.5,
      ...
      {
        title: '21:41:38  crosses displaced threshold, 140 ft MSL, 170 kt',
        lat: 30.2313367,
        lon: -81.6898305,
        alt: 15.2,
        heading: 86.9,
      ...
      {
        title: '21:41:43  touchdown, track 87 deg',
        lat: 30.2315739,
        lon: -81.6848244,
        alt: -21.4,
        heading: 89.2,
      ...
      {
        title: '21:41:50  crosses centreline left to right',
        lat: 30.2316519,
        lon: -81.6782648,
        alt: -21.4,
        heading: 91.4,
      ...
      {
        title: '21:42:01  max 74 ft right of centreline',
        lat: 30.2314786,
        lon: -81.6698659,
        alt: -21.4,
        heading: 89.1,
      ...
      {
        title: '21:42:10  crosses end of runway 10',
        lat: 30.2315498,
        lon: -81.6644598,
        alt: -21.4,
        heading: 91.5,
      ...
      {
        title: '21:42:19  seawall impact into St Johns River',
        lat: 30.2314669,
        lon: -81.6607706,
        alt: -25.1,
        heading: 91.5,
      ...
      {
        title: 'Came to rest in the St Johns River',
        lat: 30.2254669,
        lon: -81.6567706,
        alt: 260,
        heading: 300,
